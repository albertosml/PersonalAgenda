...
- [Integración continua y herramientas de construcción](integracion_continua.md)
- [Microservicios](microservicios.md)
- [Despliegue en un PaaS](despliegue_paas.md)
- [Dockerhub](dockerhub.md)
- [Almacén de datos y evaluación del rendimiento](almacen_datos_evaluacion_rendimiento.md)
...
![Añadiendo aplicación en el App Registration](images/azure_app.png)
...
![Crear rol aplicación](images/azure_role.png)
...
![Crear client secret](images/azure_client_secret_app.png)
...
![Report taurus](images/rendimiento_azure.png)

![Tiempo por petición](images/tiempo_peticion_azure.png)
